//==========================================================================================================
// TTL IC functions
// SN7400 Quad 2-Input XOR
// File Name: SN7486.v
// Functions: 
//   The 4 gates of a 7486.
//
//==========================================================================================================
...
assign p3 = (p1 & ~p2) | (~p1 & p2);
assign p6 = (p4 & ~p5) | (~p4 & p5);
assign p8 = (p9 & ~p10) | (~p9 & p10);
assign p11 = (p12 & ~p13) | (~p12 & p13);

endmodule // End of Module SN7486
